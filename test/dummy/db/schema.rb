...
ActiveRecord::Schema.define(:version => 20120516162513) do

  create_table "bcms_bitly_short_link_versions", :force => true do |t|
  ...
  create_table "bcms_bitly_short_links", :force => true do |t|
    t.integer  "version"
